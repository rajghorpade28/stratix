    ...
    <section className="py-32 bg-card relative border-t border-border/40">
      <div className="container mx-auto px-6 md:px-12 max-w-7xl">
        ...
        <div className="flex flex-col items-center text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-sm font-medium tracking-[0.1em] text-accent uppercase mb-6">Pricing Plans</h2>
          <h3 className="text-4xl md:text-5xl font-heading font-bold mb-6 leading-[1.1] tracking-tight">
        ...
        <motion.div 
          ...
          className="max-w-3xl mx-auto bg-primary border border-accent/30 rounded p-6 mb-20 text-center shadow-lg relative overflow-hidden"
        >
          <div className="absolute inset-0 bg-accent/5 mix-blend-overlay" />
          <h4 className="text-2xl md:text-3xl font-heading font-bold text-primary-foreground relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {plans.map((plan, idx) => (
            <motion.div 
              ...
              className={`relative flex flex-col p-8 md:p-10 rounded transition-colors ${
                plan.recommended 
