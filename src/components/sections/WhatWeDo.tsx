    ...
    <section className="py-32 bg-background relative border-t border-border/40">
      <div className="container mx-auto px-6 md:px-12 max-w-7xl">
        <div className="flex flex-col lg:flex-row justify-between items-start gap-16 lg:gap-24">
          ...
          >
            <h2 className="text-sm font-medium tracking-[0.1em] text-accent uppercase mb-8">What We Do</h2>
            <h3 className="text-4xl md:text-5xl font-heading font-bold leading-[1.1] tracking-tight mb-8 text-foreground">
              We help businesses improve their online presence.
            </h3>
            <p className="text-lg text-muted-foreground leading-relaxed font-sans max-w-xl mb-6">
          ...
          <motion.div 
            ...
            className="relative w-full lg:w-1/2 aspect-[4/5] bg-card rounded overflow-hidden shadow-md"
          >
            <Image 
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 border-t border-white/10 backdrop-blur-md bg-black/40">
