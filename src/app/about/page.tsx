  ...
  return (
    <main className="pt-32 pb-24 min-h-screen bg-background">
      <div className="container mx-auto px-6 md:px-12 max-w-7xl">
        ...
        {/* Header Section */}
        <section className="max-w-3xl mb-12 md:mb-24">
          <motion.h1 
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
            className="text-4xl md:text-6xl font-heading font-bold mb-6 md:mb-8 leading-[1.1] tracking-tight text-foreground"
          >
        ...
        <motion.div 
          ...
          className="w-full aspect-[16/10] md:aspect-[21/9] relative bg-card rounded mb-16 md:mb-32 overflow-hidden shadow-lg border border-border/50"
        >
          <Image 
        ...
        {/* Who/What/Who Grid */}
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-16 md:mb-24">
